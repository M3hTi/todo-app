...
export function TaskCard({ task }: TaskCardProps) {
  ...
  return (
    <TaskContextMenu task={task} completed={completed}>
      <div
        role="listitem"
        tabIndex={0}
        ...
        className={cn(
          ...
          // Right-click marks its target without selecting it; the attribute
          // selector outranks the plain border class above.
          "data-[state=open]:border-[var(--accent-text)] data-[state=open]:shadow-[0_0_0_3px_var(--ring-shadow)]",
        )}
      >
        <TaskCheckbox
          checked={completed}
